              ...
              return (
                <tr key={`colAttr${j}`}>
                  ...
                  <th
                    className={
                      "pvtAxisLabel" +
                      clickClass(clickable, isFolded(levelKeys))
                    }
              ...
              return (
                ...
                >
                  {rowKey.map(function (txt, j) {
                    ...
                    const x = compactRows
                      ? 1
                      : spanSize(rowKeys, i, j, specialCase);
                    if (x === -1) {
                      return null;
                    }
                    return (
                  ...
                  {!compactRows && rowGap ? (
                    <th className="pvtRowLabel" colSpan={rowGap + 1}>
            ...
            <tr>
              ...
              {colKeys.map(function (colKey, i) {
                ...
                return (
                  <td
                    className={
                      "pvtTotal" + (colGap ? " pvtLevel" + colGap : "")
                    }
                    key={`total${i}`}
                    onClick={
                      getClickHandler &&
